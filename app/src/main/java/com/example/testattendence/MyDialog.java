...
public class MyDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState)
    {
        ...
        if(getTag().equals(CLASS_UPDATE_DIALOG))dialog=getAUpdateClassDialog();
        if(getTag().equals(STUDENT_UPDATE_DIALOG))dialog=getAUpdateStudentDialog();

        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        return dialog;
    }

    private Dialog getAUpdateStudentDialog() {
...
//            name_edt.setText("");
    ...
    private Dialog getAUpdateClassDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.dialog, null);
